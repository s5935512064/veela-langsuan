    ...
    if (data != null) {
      import('vanilla-cookieconsent/dist/cookieconsent.js').then(() => {
        ...
        cc.run({
          ...
          cookie_name: 'velaa_langsuan_cookie',               // default: 'cc_cookie'
                ...
                blocks: [
                  {
                    ...
                    description: 'For any queries in relation to our policy on cookies and your choices, please <a class="cc-link" href="https://siamsindhorn.com/privacy">contact us</a>.',
                  }
                ]
              }
            }
